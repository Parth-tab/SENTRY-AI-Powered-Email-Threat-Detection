...
class ReportingService:
    ...
    def generate_pdf_report(cls, email_data: Dict[str, Any], analysis_data: Dict[str, Any], evidence_data: Dict[str, Any]) -> bytes:
        ...
        elements.append(Paragraph("<b>LEGAL NOTICE:</b> This forensic examination was generated by SENTRY in compliance with RFC 3227 evidence handling standards. Cryptographic hashes ensure evidence chain immutability.", subtitle_style))
