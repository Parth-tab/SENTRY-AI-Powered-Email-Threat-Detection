...
4. Artifacts: [`verification_report_cold-boot-proof.json`](artifacts/verification_report_cold-boot-proof.json) and [`verification_report_demo-freeze-v2.json`](artifacts/verification_report_demo-freeze-v2.json).
